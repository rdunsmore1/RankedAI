...
const rankings = [
  { category: "Coding & Development", href: "/coding", position: "#4", color: "#6B1E2E", score: "82" },
  { category: "Research & Summarisation", href: "/research", position: "#2", color: "#6B1E2E", score: "82" },
  { category: "Math & Science", href: "/math-science", position: "#4", color: "#B8963C", score: "82" },
];
  ...
  return (
    <>
      ...
      <div className="flex items-center gap-2 text-xs text-[#8A7F74] tabular-nums mb-8">
        ...
        <span>/</span>
        <span className="text-[#1A1A1A]">Google Gemini Review 2026</span>
      </div>
      ...
      <section className="mb-20">
        ...
        <h1 className="font-semibold font-black text-5xl sm:text-6xl leading-[1.05] tracking-tight text-[#1A1A1A] mb-6">
          ...
          <span
            ...
            style={{ backgroundImage: "linear-gradient(100deg, #6B1E2E 0%, #6366F1 100%)" }}
          >
      ...
      {/* Divider */}
      <div className="h-px bg-gradient-to-r from-[#6B1E2E]/30 via-[#6366F1]/20 to-transparent mb-20" />

      {/* ── WHAT IS GEMINI ───────────────────────────────── */}
      <section className="mb-20">
        <div className="flex items-baseline gap-3 mb-4">
          <span className="tabular-nums text-xs text-[#6B1E2E]">01</span>
          <h2 className="font-semibold text-2xl sm:text-3xl leading-tight text-[#1A1A1A]">What is Gemini?</h2>
        </div>
        <div className="pl-6 border-l border-[#D9CFC4] space-y-4 text-[#8A7F74] leading-relaxed">
          <p>
            Gemini is the flagship AI model family developed by <strong className="text-[#1A1A1A]">Google DeepMind</strong>, the research lab formed by merging Google Brain and the original DeepMind in 2023. It represents Google&apos;s unified bet on AI — a single model family designed to power everything from Google Search to Workspace to Android.
          </p>
          <p>
            The current generation includes <strong className="text-[#1A1A1A]">Gemini 1.5 Pro</strong>, the most capable model with its record-breaking 1 million token context window, and <strong className="text-[#1A1A1A]">Gemini 1.5 Flash</strong>, a faster and more efficient model available on the free tier. Gemini 2.0 Flash, an even faster next-generation model, is also available to Advanced users.
          </p>
          <p>
            What sets Gemini apart from Claude and ChatGPT is its <strong className="text-[#1A1A1A]">infrastructure advantage</strong>. Google has baked Gemini into Search, Gmail, Google Docs, Sheets, Slides, Drive, and Meet. For users whose work lives inside Google&apos;s ecosystem — which is most of the planet — this integration is genuinely transformative in a way that third-party AI tools simply cannot match.
          </p>
          <div className="bg-[#F0EBE1] border border-[#D9CFC4] rounded-lg p-4 mt-2">
            ...
            <div className="flex items-center gap-3">
              <span className="tabular-nums font-bold text-3xl text-[#6B1E2E]">82</span>
              <div className="flex-1 h-2 bg-[#D9CFC4] rounded-full overflow-hidden">
                <div className="h-full rounded-full bg-[#6B1E2E]" style={{ width: "82%" }} />
              </div>
      ...
      <section className="mb-20">
        <div className="flex items-baseline gap-3 mb-4">
          ...
          <h2 className="font-semibold text-2xl sm:text-3xl leading-tight text-[#1A1A1A]">What is Gemini best at?</h2>
        </div>
      ...
      <section className="mb-20">
        <div className="flex items-baseline gap-3 mb-4">
          ...
          <h2 className="font-semibold text-2xl sm:text-3xl leading-tight text-[#1A1A1A]">Gemini pricing</h2>
        </div>
        <div className="pl-6 border-l border-[#D9CFC4] space-y-4 text-[#8A7F74] leading-relaxed">
          ...
          <div className="grid sm:grid-cols-3 gap-4 mt-2">
            {[
              ...
              <div
                key={plan.tier}
                className={`rounded-card p-5 border ${plan.highlight ? "border-[#6B1E2E]/40 bg-[#6B1E2E]/5" : "border-[#D9CFC4] bg-[#F0EBE1]"}`}
              >
          ...
          <p className="text-sm mt-2">
            At <strong className="text-[#1A1A1A]">$19.99/month</strong>, Gemini Advanced is priced just below Claude Pro and ChatGPT Plus — and the 2TB Drive storage alone makes it worthwhile for heavy Google users. The free tier is genuinely capable, making Gemini the strongest free AI option for users already on Google accounts.
          </p>
        </div>
      </section>
      ...
      <section className="mb-20">
        <div className="flex items-baseline gap-3 mb-4">
          ...
          <h2 className="font-semibold text-2xl sm:text-3xl leading-tight text-[#1A1A1A]">Gemini pros and cons</h2>
        </div>
      ...
      <section className="mb-20">
        <div className="flex items-baseline gap-3 mb-4">
          ...
          <h2 className="font-semibold text-2xl sm:text-3xl leading-tight text-[#1A1A1A]">How Gemini ranks on RankedAI™</h2>
        </div>
        <div className="pl-6 border-l border-[#D9CFC4] space-y-4 text-[#8A7F74] leading-relaxed">
          <p>
      ...
      <section className="mb-20">
        <div className="flex items-baseline gap-3 mb-4">
          ...
          <h2 className="font-semibold text-2xl sm:text-3xl leading-tight text-[#1A1A1A]">Gemini vs ChatGPT vs Claude</h2>
        </div>
        <div className="pl-6 border-l border-[#D9CFC4]">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[#D9CFC4] bg-[#F0EBE1]">
                  ...
                  <th className="text-left px-4 py-3 font-semibold font-semibold text-[#6B1E2E] text-xs uppercase tracking-wider">Gemini</th>
              ...
              <tbody>
                {comparison.map((row, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-[#1A1A1A] font-semibold text-xs">{row.gemini}</td>
      ...
      <section className="mb-20">
        ...
        <div className="pl-6 border-l border-[#D9CFC4] space-y-4 text-[#8A7F74] leading-relaxed">
          <p>
            Gemini is the right AI for a specific and large group of people: <strong className="text-[#1A1A1A]">those who live inside Google&apos;s ecosystem</strong>. If your work revolves around Gmail, Google Docs, Sheets, and Drive — and most knowledge workers&apos; does — the friction of switching to a separate AI tool is real and Gemini eliminates it entirely. The Workspace integration is not a gimmick; it is a genuine productivity unlock that Claude and ChatGPT cannot match.
          </p>
          <p>
          ...
          <p>
            Our recommendation: if you&apos;re a Google Workspace user, <strong className="text-[#1A1A1A]">Gemini Advanced at $19.99/month is a no-brainer</strong> — the 2TB Drive storage alone is worth it on most Google One plans. If you&apos;re not already in the Google ecosystem, Claude or ChatGPT will almost certainly serve you better.
          </p>
        </div>
      </section>
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg, #6B1E2E08 0%, #6366F108 50%, #6B1E2E08 100%)" }}
      >
        <div className="tabular-nums text-xs text-[#6B1E2E] mb-3 uppercase tracking-widest">See where Gemini ranks</div>
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          <Link
            href="/"
            className="px-6 py-2.5 bg-[#6B1E2E] text-white font-semibold text-sm rounded-lg hover:bg-[#9333ea] transition-colors"
          >
        ...
        <div className="space-y-3">
          {[
            ...
            >
              ...
              <span className="text-[#8A7F74] text-sm shrink-0 ml-4 transition-colors" style={{ color: link.color }}>→</span>
            </Link>
          ))}
        </div>
      </div>
      ...
      <div className="pt-6 border-t border-[#D9CFC4] flex flex-wrap gap-4 text-xs">
        ...
        <Link href="/math-science" className="text-[#8A7F74] hover:text-[#1A1A1A] transition-colors">Math Rankings</Link>
        <Link href="/tool/gemini" className="text-[#8A7F74] hover:text-[#1A1A1A] transition-colors">Gemini tool page</Link>
      </div>
    </div>
    </>
  );
