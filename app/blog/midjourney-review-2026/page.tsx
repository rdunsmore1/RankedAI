  ...
  return (
    <>
      ...
      <div className="flex items-center gap-2 text-xs text-[#8888A0] font-mono mb-8">
        ...
        <span>/</span>
        <span className="text-[#F0F0F5]">Midjourney Review 2026</span>
      </div>

      {/* ── HERO ─────────────────────────────────────────── */}
      <section className="mb-20">
        <div className="flex flex-wrap items-center gap-3 mb-5">
          <span className="font-mono text-[11px] font-semibold tracking-widest uppercase text-[#EC4899]">Independent Review</span>
        ...
        <h1 className="font-syne font-black text-5xl sm:text-6xl leading-[1.05] tracking-tight text-[#F0F0F5] mb-6">
          ...
          <span
            ...
            style={{ backgroundImage: "linear-gradient(100deg, #EC4899 0%, #F59E0B 100%)" }}
          >
            Still the Best AI Image Generator?
          </span>
        </h1>

        <p className="text-lg text-[#8888A0] leading-relaxed border-l-2 border-[#EC4899]/40 pl-4 max-w-[680px]">
        ...
        <div className="pl-6 border-l border-[#1E1E2E] space-y-4 text-[#8888A0] leading-relaxed">
          ...
          <div className="bg-[#13131A] border border-[#1E1E2E] rounded-lg p-4 mt-2">
            ...
            <div className="flex items-center gap-3">
              <span className="font-mono font-bold text-3xl text-[#EC4899]">92</span>
              <div className="flex-1 h-2 bg-[#1E1E2E] rounded-full overflow-hidden">
                <div className="h-full rounded-full bg-[#EC4899]" style={{ width: "92%" }} />
              </div>
              <span className="text-xs text-[#8888A0]">/ 100</span>
            </div>
            <p className="text-xs text-[#8888A0] mt-2">Derived from independent image quality evaluations, prompt adherence benchmarks, and community voting.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-20">
        <div className="flex items-baseline gap-3 mb-4">
          <span className="font-mono text-xs text-[#EC4899]">02</span>
          <h2 className="font-syne font-bold text-2xl sm:text-3xl leading-tight text-[#F0F0F5]">What is Midjourney best at?</h2>
        </div>
      ...
      <section className="mb-20">
        <div className="flex items-baseline gap-3 mb-4">
          <span className="font-mono text-xs text-[#EC4899]">03</span>
          <h2 className="font-syne font-bold text-2xl sm:text-3xl leading-tight text-[#F0F0F5]">Midjourney pricing</h2>
        </div>
        <div className="pl-6 border-l border-[#1E1E2E] space-y-4 text-[#8888A0] leading-relaxed">
          <p>
            Midjourney has <strong className="text-[#F0F0F5]">no free tier</strong> — a paid subscription is required before you can generate any images. This is one of the most common friction points for new users, but the quality of output justifies the cost for professionals and serious creatives.
          </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-2">
            {[
              ...
              <div
                key={plan.tier}
                className={`rounded-card p-5 border overflow-hidden ${plan.highlight ? "border-[#EC4899]/40 bg-[#EC4899]/5" : "border-[#1E1E2E] bg-[#13131A]"}`}
              >
      ...
      <section className="mb-20">
        <div className="flex items-baseline gap-3 mb-4">
          <span className="font-mono text-xs text-[#EC4899]">04</span>
          <h2 className="font-syne font-bold text-2xl sm:text-3xl leading-tight text-[#F0F0F5]">Midjourney pros and cons</h2>
        </div>
      ...
      <section className="mb-20">
        <div className="flex items-baseline gap-3 mb-4">
          <span className="font-mono text-xs text-[#EC4899]">05</span>
          <h2 className="font-syne font-bold text-2xl sm:text-3xl leading-tight text-[#F0F0F5]">How Midjourney ranks on RankedAI™</h2>
        </div>
        <div className="pl-6 border-l border-[#1E1E2E] space-y-4 text-[#8888A0] leading-relaxed">
          <p>
          ...
          <div className="mt-2">
            {rankings.map((r) => (
              <Link
                key={r.category}
                href={r.href}
                className="group bg-[#13131A] border border-[#1E1E2E] hover:border-[#EC4899]/30 rounded-card p-4 transition-colors block max-w-sm"
              >
                ...
                <div className="text-[10px] text-[#8888A0] mt-2 group-hover:text-[#EC4899] transition-colors">
                  View full rankings →
                </div>
              </Link>
            ))}
      ...
      <section className="mb-20">
        <div className="flex items-baseline gap-3 mb-4">
          <span className="font-mono text-xs text-[#EC4899]">06</span>
          <h2 className="font-syne font-bold text-2xl sm:text-3xl leading-tight text-[#F0F0F5]">Midjourney vs DALL-E 3 vs Stable Diffusion</h2>
        </div>
        <div className="pl-6 border-l border-[#1E1E2E]">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[#1E1E2E] bg-[#13131A]">
                  ...
                  <th className="text-left px-4 py-3 font-syne font-semibold text-[#EC4899] text-xs uppercase tracking-wider">Midjourney</th>
                  <th className="text-left px-4 py-3 font-syne font-semibold text-[#8888A0] text-xs uppercase tracking-wider">DALL-E 3</th>
                  <th className="text-left px-4 py-3 font-syne font-semibold text-[#8888A0] text-xs uppercase tracking-wider">Stable Diffusion</th>
                </tr>
              </thead>
              <tbody>
                {comparison.map((row, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-[#F0F0F5] font-semibold text-xs">{row.midjourney}</td>
                    <td className="px-4 py-3 text-[#8888A0] text-xs">{row.dalle}</td>
                    <td className="px-4 py-3 text-[#8888A0] text-xs">{row.sd}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section className="mb-20">
        <div className="flex items-baseline gap-3 mb-4">
          <span className="font-mono text-xs text-[#EC4899]">07</span>
          <h2 className="font-syne font-bold text-2xl sm:text-3xl leading-tight text-[#F0F0F5]">How to get started with Midjourney</h2>
        </div>
        <div className="pl-6 border-l border-[#1E1E2E] space-y-4 text-[#8888A0] leading-relaxed">
          ...
          <div className="space-y-3 mt-2">
            {[
              ...
              <div key={item.step} className="bg-[#13131A] border border-[#1E1E2E] rounded-card p-5 flex gap-4">
                <span className="font-mono font-bold text-2xl text-[#EC4899]/30 shrink-0 leading-none mt-0.5">{item.step}</span>
                <div>
                  <h3 className="font-syne font-bold text-[#F0F0F5] text-sm mb-2">{item.title}</h3>
                  <p className="text-sm leading-relaxed">{item.body}</p>
                </div>
              </div>
            ))}
          ...
          <div className="bg-[#EC4899]/5 border border-[#EC4899]/20 rounded-card p-4 mt-2">
            <div className="font-mono text-xs text-[#EC4899] mb-2 uppercase tracking-wider">Prompt tip</div>
            <p className="text-sm leading-relaxed">
              Start with a clear subject, then layer in style, lighting, and mood:{" "}
              <code className="text-xs bg-[#0A0A0F] px-1.5 py-0.5 rounded text-[#EC4899]">/imagine a cinematic portrait of a woman, golden hour lighting, shallow depth of field, Kodak Portra 400, editorial fashion photography --ar 2:3</code>. The <code className="text-xs bg-[#0A0A0F] px-1.5 py-0.5 rounded text-[#EC4899]">--ar</code> flag sets aspect ratio.
            </p>
          </div>
        </div>
      </section>
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg, #EC489908 0%, #F59E0B08 50%, #A855F708 100%)" }}
      >
        <div className="font-mono text-xs text-[#EC4899] mb-3 uppercase tracking-widest">See where Midjourney ranks</div>
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          <Link
            href="/image-gen"
            className="px-6 py-2.5 bg-[#EC4899] text-white font-syne font-bold text-sm rounded-lg hover:bg-[#db2777] transition-colors"
          >
      ...
      <div className="pt-6 border-t border-[#1E1E2E] flex flex-wrap gap-4 text-xs">
        ...
        <Link href="/image-gen" className="text-[#8888A0] hover:text-[#F0F0F5] transition-colors">Image Gen Rankings</Link>
