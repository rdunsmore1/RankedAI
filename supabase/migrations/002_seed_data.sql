...
INSERT INTO tools (name, slug, tagline, description, logo_url, website_url, affiliate_url, pricing_model, price_details, is_sponsored, benchmark_score) VALUES
  ...
  ('Sora', 'sora', 'OpenAI''s text-to-video generation model', E'## Sora by OpenAI\n\nSora is OpenAI''s text-to-video generation model capable of creating realistic and imaginative scenes from text.\n\n### Strengths\n- Up to 1080p, 20-second videos\n- High realism and consistency\n- Storyboard mode\n- Remix existing videos\n\n### Pricing\nIncluded with ChatGPT Plus. Pro for longer videos.', null, 'https://sora.com', 'https://sora.com', 'Freemium', 'With ChatGPT Plus ($20/mo)', false, 88),
